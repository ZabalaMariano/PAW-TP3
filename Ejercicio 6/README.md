...
-Dentro del directorio controllers: punto6.php<br>
-Dentro del directorio views: punto6.view.php<br>
-Dentro del directorio js: reproductor.js y conf.js<br>
-Dentro del directorio static: styles.css<br>
-Dentro del directorio multimedia: incluye videos e imagenes de la página.<br><br>
