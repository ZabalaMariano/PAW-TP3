...
-Dentro del directorio controllers: punto2.php<br>
-Dentro del directorio views: punto2.view.php<br>
-Dentro del directorio js: tateti.js, jugadores.js y conf.js<br>
-Dentro del directorio static: styles.css<br><br>
