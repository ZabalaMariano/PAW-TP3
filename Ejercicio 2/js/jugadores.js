...
Juego.generarMenuJugadores = function (section){
    ...
    form = document.createElement("form");//Creo form
    ...
    label1 = document.createElement("label");//Creo label
    label1.classList.add("tatetiFormLabel1");
    label1.setAttribute("for","nombreX");
    label1.textContent = "Nombre jugador X: ";
    form.appendChild(label1);

    input1 = document.createElement("input");//Creo input
    input1.classList.add("tatetiFormInput1");
    input1.setAttribute("type","text");
    input1.setAttribute("name","nombreX");
    input1.setAttribute("pattern","[A-Za-z\s]+");
    input1.setAttribute("title","Solo letras y espacios");
    input1.setAttribute("required",true);
    form.appendChild(input1);
    
    label2 = document.createElement("label");//Creo label
    label2.classList.add("tatetiFormLabel2");
    label2.setAttribute("for","nombreO");
    label2.textContent = "Nombre jugador O: ";
    form.appendChild(label2);

    input2 = document.createElement("input");//Creo label
    input2.classList.add("tatetiFormInput2");
    input2.setAttribute("type","text");
    input2.setAttribute("name","nombreO");
    input2.setAttribute("pattern","[A-Za-z\s]+");
    input2.setAttribute("title","Solo letras y espacios");
    input2.setAttribute("required",true);
    form.appendChild(input2);

    boton = document.createElement("div");//Creo input enviar
    ...
    if(e.target && e.target.matches("div.tatetiFormBoton")){
        ...
        if(nombreX != "" && nombreO != ""){
            if(nombreX != nombreO){
                ...
                mensaje.classList.remove("tatetiMensajeInicio");//Le quito una clase
